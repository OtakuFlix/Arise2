    ...
    <View style={[styles.container, { height: dimensions.height }]}>
      ...
      >
        {animeList.map((anime, index) => {
          ...
          const videoId = anime.vdo ? getVideoId(anime.vdo) : '';
          const youtubeUrl = videoId ? 
            `https://www.youtube.com/embed/${videoId}?autoplay=1&mute=1&controls=0&disablekb=1&loop=1&playlist=${videoId}&modestbranding=1&rel=0&showinfo=0&fs=0&iv_load_policy=3&enablejsapi=1` : 
            '';
